...
import {
    Platform, ListView, StyleSheet, StatusBar, Text, TouchableHighlight, View, FlatList
} from 'react-native';
            ...
            <View style={styles.watchControlContainer}>
                ...
                <View style={{flex: 1, alignItems: "flex-end"}}>
                    <TouchableHighlight style={styles.btnStart} underlayColor="#eee" onPress={() => this._startWatch()}>
                        <Text
                            style={[styles.btnStartText, {color: this.state.startBtnColor}]}>{this.state.startBtnText}</Text>
                    </TouchableHighlight>
                </View>
            </View>
        )
    ...
    _startWatch() {
        ...
        let interval = setInterval(
            () => {
                ...
                secsecond = Math.floor((seccountingTime - 6 * 1000 * secminute) / 1000);
    ...
    render() {
        return (
            <View style={styles.watchContainer}>
                ...
                <WatchControl addRecord={() => this._addRecord()} clearRecord={() => this._clearRecord()}
                              startWatch={() => this._startWatch()} stopWatch={() => this._stopWatch()}></WatchControl>
...
const styles = StyleSheet.create({
    ...
    watchFaceContainer: {
        ...
        backgroundColor: "#a3f",
        borderTopWidth: 10, borderTopColor: "#f3f",
        borderBottomWidth: 20, borderBottomColor: "#f3f",
        height: 170,
    },
    sectionTime: {
        fontSize: 30,
